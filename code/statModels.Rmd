...
```{r what the fuck is wrong with this}
et9 <- et2[which(et2$site == et2$site[1]),]



#One of the site has all NA values for prediction covariates making it unusable. Will need to find a way to remove these sites before prediction...


et2[which(et2$site == 'CTDEP_1243'),]
ddply( et2, .(site), airTemp[1])


ddply( et9, .(site), summarize, slopeSeg2=coef(lm(pred ~ airTemp))[2])
