...
dataInDir <- paste0(baseDir, 'temperatureProject/dataIn/')
dataOutDir <- paste0(baseDir, 'temperatureProject/dataOut/')
graphsDir <- paste0(baseDir, 'temperatureProject/graphs/')

source(paste0(baseDir, 'temperatureProject/code/functions/temperatureModelingFunctions.R'))
...
removeSelectSites <- T
sitesToRemove <- paste0(baseDir, 'temperatureProject/dataIn/sitesToRemoveAllNE.csv')
