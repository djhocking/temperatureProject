# This script uses paired stream and air temperature to output the spring and fall breakpoints
#   as determined by a defined window based on the calculated air/water temperature index.

```{r Load libraries and define directories}
rm(list=ls())
...
# This section determines the mean breakpoint from the smallest scale where a mean exists and assigns it to sites
#   that did not have enough data to calculate a breakpoint (start with site mean and work up to HUC4 mean).
```{r meanBPs}
