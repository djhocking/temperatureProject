...
save(masterData, file = paste0('C:/KPONEIL/GitHub/projects/temperatureProject/dataIn/', dataSource, '/streamTempSitesObservedClimateData_', dataSource, '_NeedPrcp.RData'))
```
...
save(masterData, file = paste0('C:/KPONEIL/GitHub/projects/temperatureProject/dataIn/', dataSource, '/streamTempSitesObservedClimateData_', dataSource, '.RData'))
```