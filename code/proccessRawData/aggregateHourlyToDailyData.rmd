...
# ======================
temp1      <- read.csv("West Brook T downloaded 11May2014 Cleaned.csv", header=T)
temp1$temp <- as.numeric(as.character(temp1$temp)) #Because temp gets read in as factor

temp2      <- read.csv("West Brook T downloaded 14April2014 Cleaned.csv", header=T)
...
# Read metadata:
# ==============
meta <- read.csv('West Brook T Spring2014 Site Locations.csv')
